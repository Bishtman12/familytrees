        ...
        <HomepageStyled>
            <header>
                <div className="search-container">
                    <div className="logo">
                        <a href='/' onClick={() => { setRendered('full_tree') }}>Family Tree</a>
                    </div>
                    <form action="" className="search-form" onSubmit={handleSubmit}>
                        <div className="input-control">
                            <input type="text" placeholder="Search Name" value={search} onChange={handleChange} />
                            <button type="submit" onSubmit={handleSubmit}>Search</button>
                        </div>
                    </form>
                    <div className='filter-btn-right'>
                        <a className='button-nav' href='/'>Home</a>
                        <a className='button-nav' onClick={() => {
                            setRendered('full_tree')
                            getTreeData()
                        }}>Load Full Tree</a>
                        <a className='button-nav' onClick={() => { setRendered('about_me') }}>About me</a>
                    </div>
                </div>
            </header>
            {switchComponent()}
